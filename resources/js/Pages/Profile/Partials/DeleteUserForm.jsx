        ...
        <section className={`space-y-6 ${className}`}>
            <header>
                ...
                <p className="mt-1 text-sm text-gray-600">
                    ...
                    de supprimer votre compte, veuillez télécharger toutes les données ou informations que vous souhaitez conserver.
                </p>
            </header>
            ...
            <Modal show={confirmingUserDeletion} onClose={closeModal}>
                <form onSubmit={deleteUser} className="p-6">
                    ...
                    <p className="mt-1 text-sm text-gray-600">
                        ...
                        entrer votre mot de passe pour confirmer que vous souhaitez définitivement supprimer votre compte.
                    </p>
